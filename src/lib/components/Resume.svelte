...
<div class="flex flex-col w-screen sm:w-full h-full pt-16 px-10 lg:px-20">
	<div class="text-center md:text-left">
		<h1 class="mb-2 text-5xl font-extrabold tracking-tight leading-none text-scYellow">Resume.</h1>
		<h2
			class="pb-6 text-3xl font-extrabold tracking-tight leading-none text-text dark:text-textDark"
		>
			Where I've been.
		</h2>
	</div>
